...
function isCanisterUnavailableError(error: unknown): boolean {
  ...
  if (message.includes('reject_code: 5') || message.includes('"reject_code":5') || message.includes('"reject_code": 5')) return true;
  ...
  if (message.includes('Request ID:') && message.includes('Reject code:')) return true;
