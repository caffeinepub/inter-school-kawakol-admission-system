...
export default function ContactDetailsSection({ formData, setFormData, disabled }: ContactDetailsSectionProps) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="fathersNameAsPerAadhaar">Father's Name as per Aadhaar *</Label>
            <Input
              id="fathersNameAsPerAadhaar"
              value={formData.fathersNameAsPerAadhaar || ''}
              onChange={(e) => setFormData({ ...formData, fathersNameAsPerAadhaar: e.target.value })}
              placeholder="Father's name as on Aadhaar card"
              disabled={disabled}
            />
          </div>
          <div className="space-y-2">
            <Label htmlFor="mothersNameAsPerAadhaar">Mother's Name as per Aadhaar *</Label>
            <Input
              id="mothersNameAsPerAadhaar"
              value={formData.mothersNameAsPerAadhaar || ''}
              onChange={(e) => setFormData({ ...formData, mothersNameAsPerAadhaar: e.target.value })}
