...
import { AdmissionForm, PassingDivision } from '../backend';
...
export default function PreviousExamSection({ formData, setFormData, disabled }: PreviousExamSectionProps) {
  return (
    <Card>
      <CardHeader>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => setFormData({ ...formData, previousExam: value })}
              disabled={disabled}
            >
          ...
          <div className="space-y-2">
            <Label htmlFor="previousRollNo">Roll Number of Previous Class *</Label>
            <Input
              id="previousRollNo"
              value={formData.previousRollNo || ''}
              onChange={(e) => setFormData({ ...formData, previousRollNo: e.target.value })}
              disabled={disabled}
            />
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => setFormData({ ...formData, passingYear: BigInt(value) })}
              disabled={disabled}
            >
          ...
          <div className="space-y-2">
            ...
            <Input
              id="marksObtained"
              type="number"
              value={formData.marksObtained ? Number(formData.marksObtained) : ''}
              onChange={(e) => setFormData({ ...formData, marksObtained: BigInt(e.target.value || 0) })}
              disabled={disabled}
            />
          </div>
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => setFormData({ ...formData, passingDivision: value as PassingDivision })}
              disabled={disabled}
            >
