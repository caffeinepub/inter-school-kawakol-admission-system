...
import { AdmissionForm, State } from '../backend';
...
export default function AddressSection({ formData, setFormData, disabled }: AddressSectionProps) {
  return (
    <Card>
      <CardHeader>
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setFormData({
                  ...formData,
                  address: { ...formData.address!, policeStation: e.target.value },
                })
              }
              disabled={disabled}
            />
