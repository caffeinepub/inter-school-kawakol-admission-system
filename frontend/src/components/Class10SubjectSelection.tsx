...
export default function Class10SubjectSelection({ formData, setFormData, disabled }: Class10SubjectSelectionProps) {
  ...
  const toggleSubject = (category: 'mil' | 'sil' | 'compulsory', subject: string) => {
    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        <div className="space-y-3">
          <Label className="text-base font-semibold">M.I.L. Subject's (Select Multiple) *</Label>
        ...
        <div className="space-y-3">
          <Label className="text-base font-semibold">S.I.L. Subject's (Select Multiple) *</Label>
          <div className="grid grid-cols-2 gap-3">
        ...
        <div className="space-y-3">
          <Label className="text-base font-semibold">Compulsory Subject's (Select Multiple) *</Label>
          <div className="grid grid-cols-2 gap-3">
        ...
        <div className="space-y-3">
          <Label className="text-base font-semibold">Extra Subject (Select One) *</Label>
          <RadioGroup
