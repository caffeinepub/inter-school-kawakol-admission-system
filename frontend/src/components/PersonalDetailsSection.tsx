...
import { AdmissionForm, Gender, Category, ExternalBlob } from '../backend';
...
export default function PersonalDetailsSection({ formData, setFormData, disabled }: PersonalDetailsSectionProps) {
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Upload a passport-size photo. Accepted formats: JPG, PNG. Maximum size: 5MB.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="studentName">Student Name (In Capital Letters) *</Label>
            <Input
              id="studentName"
          ...
          <div className="space-y-2">
            ...
            <Input
              id="dateOfBirth"
              type="date"
              value={formData.dateOfBirth ? new Date(Number(formData.dateOfBirth) / 1000000).toISOString().split('T')[0] : ''}
              onChange={(e) => setFormData({ ...formData, dateOfBirth: BigInt(new Date(e.target.value).getTime() * 1000000) })}
              disabled={disabled}
            />
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label htmlFor="fatherName">Father's Name (In Capital Letters) *</Label>
            <Input
              id="fatherName"
          ...
          <div className="space-y-2">
            <Label htmlFor="motherName">Mother's Name (In Capital Letters) *</Label>
            <Input
              id="motherName"
        ...
        <div className="space-y-2">
          ...
          <RadioGroup
            ...
            onValueChange={(value) => setFormData({ ...formData, physicallyHandicapped: value === 'yes' })}
            disabled={disabled}
          >
          ...
          <div className="grid md:grid-cols-3 gap-4 p-4 bg-muted rounded-lg">
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => setFormData({ ...formData, handicapType: e.target.value })}
                disabled={disabled}
              />
            </div>
            <div className="space-y-2">
              ...
              <Input
                ...
                type="number"
                value={formData.handicapPercentage ? Number(formData.handicapPercentage) : ''}
                onChange={(e) => setFormData({ ...formData, handicapPercentage: BigInt(e.target.value || 0) })}
                disabled={disabled}
              />
            </div>
            <div className="space-y-2">
